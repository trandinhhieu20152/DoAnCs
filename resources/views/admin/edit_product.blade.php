    ...
    <div class="mt-4 mb-3 p-3 button-container bg-white border shadow-sm">
        ...
        <form action="{{ route('Product.update',['id'=>$product->product_id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" id="input-4" name="product_price" class="form-control" value="{{ $product->product_price }}" />
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea rows="5" class="form-control" id="input-11" name="product_des">{{ $product->product_des }}</textarea>
                </div>
            </div>
