...
<div class="col-sm-7" style="margin-top:50px">
    ...
    <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
        <h2 class="mb-2">Tài khoản Admin</h2>
        <form action="{{URL::to('/save-account')}}" method="post" class="form-horizontal mt-4 mb-5">
            {{csrf_field()}}
            ...
            <div class="d-flex">
                <div class="ml-auto">
                    <button type="submit" class="btn btn-primary" style="margin-right:20px">Thêm tài khoản</button>
                </div>
            </div>
        </form>
    </div>
